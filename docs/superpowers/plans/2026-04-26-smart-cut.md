...
Run: `xcodebuild test -scheme SonicMerge -destination 'platform=iOS Simulator,name=iPhone 16' -only-testing:SonicMergeTests/SourceHasherTests`
...
Run: `xcodebuild build -scheme SonicMerge -destination 'platform=iOS Simulator,name=iPhone 16'`
...
Run: `xcodebuild test -scheme SonicMerge -destination 'platform=iOS Simulator,name=iPhone 16' -only-testing:SonicMergeTests/EditListTests`
