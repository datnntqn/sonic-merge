...
/// App icon scale — glyph occupies 84% of the 1024×1024 canvas, leaving
/// ~8% padding on each side. Comfortable middle ground between full-bleed
/// and Watch-style padded. User picked option C in the visual companion.
/// Tab-bar PNGs stay full-bleed since the tab-bar UI already pads icons.
let appIconGlyphScale: CGFloat = 0.84
...
await MainActor.run {
    // App icon — 1024×1024, deep navy bg, fire gradient glyph (centered, ~8% padding)
